...
if (isset($_SESSION['email']) && isset($_POST['formID'])) {
    ...
    for ($i = 0; $i < $noofPeople; $i++) {
        ...
        $qString = sprintf('replace into toc_events (hid, toc_regid, toc_regEmail, toc_broker_company, toc_broker_type, toc_firstname, toc_lastname, 
...
("%s", "%s", "%s", "%s","%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s")',
    ...
    $dbc->close();
    //send_notice("hotel");
    header("Location: reg_newEvent_broker.php?e0=" . $error0 . "&e1=" . $error1 . "&e2=" . $error2 . "&golf=" . $errorGolf . "&e5=" . $error5 . "&e6=" . $error6 . "&e7=" . $error7 . "&e8=" . $error8 . "&e9=" . $error9);
