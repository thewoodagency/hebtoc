...
if(isset($_SESSION['admin']) && $_SESSION['admin'] == 'kashwin50@hotmail.com')
{
	...
	$qString = 'SELECT toclevel, tlAmount, company, hfirst, hlast, htitle FROM toc_hall inner join toc_register on regID=idtoc_register
inner join toc_level on toclevel = tlName where hlast <> \'\' and tlAmount > 100000 order by company, hlast';
	$r = $dbc->query($qString);
	$tbrows = '';
	$rowcolor = 0;
...
<div id="content">
<p><a href="admin_reception1_excel.php">Excel</a></p>
<table id="myTable" class="tablesorter"> 
<thead><tr><th>Sponsorship level</th><th>Company Name</th><th>Attendees</th><th>Title</th></tr></thead>
<? echo $tbrows; ?>
</table>
</div>
<!-- InstanceEndEditable -->
