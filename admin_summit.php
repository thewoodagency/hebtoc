...
if(isset($_SESSION['admin']) && $_SESSION['admin'] == 'kashwin50@hotmail.com')
{
	...
	$qString = 'SELECT toclevel, company, hfirst, hlast, htitle FROM toc_summit inner join toc_register on regID=idtoc_register where hlast <> \'\' order by company, hlast';
	$r = $dbc->query($qString);
	$tbrows = '';
	$rowcolor = 0;
...
<div id="content">
<p><a href="admin_summit_excel.php">Excel</a></p>
