...
if(isset($_POST['formID'])) {
    $password = $_POST['password']; //HEBTOC2019
    $company = $_POST['companyName'];
    $employees = "";
    if ($password === 'HEBTOC2020')
    {
...
<body>
<form onsubmit="return verify();" action="charity_waiver_save.php" method="post" name="form_32814544278863" id="32814544278863" accept-charset="utf-8">
  ...
  <div class="form-all">
        <label class="form-label-left" id="label_5" for="input_5">
           <p align="center"><strong><u>Authorization To Reproduce Physical Likeness</u></strong></p>
            ...
            <p>            Whereas,  HEB will be sponsoring and the TOC Trust will be hosting the HEB Tournament of  Champions (the &ldquo;TOC&rdquo;) and related activities, a charitable fundraiser  benefitting various and numerous charities throughout the state of Texas, on or  around June 6, <?php echo date("Y") ?>;  </p>
            <p>Whereas, the TOC includes Charity Work Projects (the “Charity Projects”) held at several locations in the Greater San Antonio area, including but not limited to those hosted by the following participating organizations: Homes for Our Troops, the San Antonio Food Bank, Boys & Girls Club of San Antonio Calderon Branch, Daughters of Charity, Davis Scott YMCA, and Tragedy Assistance Program for Survivors (collectively, the “Participating Organizations”); </p>
