...
<script type="text/javascript">
   JotForm.init(function(){
	  ...
	  $('damount').hint('ex: 5000');
   });
</script>
    <script src='https://www.google.com/recaptcha/api.js'></script>
</head>
<body>
<form class="jotform-form" action="registerd_proc.php" method="post" name="form_32814544278863" id="32814544278863" accept-charset="utf-8">
  <input type="hidden" name="formID" value="32814544278863" />
  <input type="hidden" name="new_reg" value="true" />
  <div class="form-all">
  <div id="info"><h3>If you have already registered, <a href="login_proc.php">please login to your account</a> to review or modify the sponsorship forms</h3><h3 align="right"><a href="/">Back to homepage</a></h3></div>
    <ul class="form-section">
     <li class="form-line" id="id_5">
        ...
        <div id="cid_5" class="form-input">
          <select class="form-dropdown validate[required] selectfont" style="width:230px" id="level" name="level">
            <option value='Donation Only'>Donation Only </option>
          </select>
        </div>
      </li>
      <li class="form-line" id="id_1">
        <label class="form-label-left" id="label_1" for="input_1">
          Donation Amount ($)<span class="form-required">*</span>
        </label>
        <div id="cid_1" class="form-input">
          <input type="text" class=" form-textbox validate[required, Numeric]" data-type="input-textbox" id="damount" name="damount" size="55" />
        </div>
      </li>
      <li class="form-line" id="id_1">
        <label class="form-label-left" id="label_1" for="input_1">
      ...
      <li class="form-line" id="id_12">
        ...
        <div id="cid_12" class="form-input">
            <span class="form-sub-label-container">
                <input maxlength="3" class="form-textbox validate[required]" type="number" name="oarea" id="oarea" size="3" min="100" max="999">
            -
            <label class="form-sub-label" for="input_12_area" id="sublabel_area"> Area Code </label></span>
            <span class="form-sub-label-container">
                <input class="form-textbox validate[required]" type="number" name="ophone" id="ophone" maxlength="7" size="8" min="1000000" max="9999999">
            <label class="form-sub-label" for="input_12_phone" id="sublabel_phone" maxlength="7"> Phone Number </label></span>
        </div>
      </li>
      <li class="form-line" id="id_11">
        ...
        <div id="cid_11" class="form-input"><span class="form-sub-label-container">
                <input class="form-textbox validate[required]" type="number" name="carea" id="carea" size="3" maxlength="3" min="100" max="999">
            -
            <label class="form-sub-label" for="input_11_area" id="sublabel_area"> Area Code </label></span>
            <span class="form-sub-label-container">
                <input class="form-textbox validate[required]" type="number" name="cphone" id="cphone" size="8" maxlength="7" min="1000000" max="9999999">
     ...
     <!--<li>
        REGISTRATION WILL OPEN ON WEDNESDAY, JANUARY 2, 2019
      </li>-->
    </ul>
  </div>
