...
if(isset($_SESSION['admin']) && $_SESSION['admin'] == 'kashwin50@hotmail.com')
{
	...
	$qString = 'SELECT toclevel, tlAmount, company, hfirst, hlast, htitle FROM toc_welcome inner join toc_register on regID=idtoc_register inner join toc_level on toclevel = tlName where hlast <> \'\' order by company, hlast';
	$r = $dbc->query($qString);
	$tbrows = '';
	$rowcolor = 0;
...
<div id="content">
<p><a href="admin_social_excel.php">Excel</a></p>
