...
if(isset($_POST['formID'])) {
	...
	if (login_process($email, $password))
	{
        ...
        || $email == 'kotzur.lacey@heb.com')
		{
			$_SESSION['admin']='kashwin50@hotmail.com';
			header("Location: admin_panel.php");
		}
		else header("Location: check_multiplecompany.php"); 
		//else header("Location: reg_info.php"); 
		die();
	} else {
		if (hasAccount($email)) { 
			$message = "Your login information is incorrect. <a href='login_recovery.php'>Recover your password</a>";
		} else {
			$message = "No account is found under " . $email . ". Please <a href='register.php'>register here</a> to create your account";
		}
	}
}
...
<form class="jotform-form" action="" method="post" name="form_32814544278863" id="32814544278863" accept-charset="utf-8">
  ...
  <div class="form-all"><div id="logo"><a href="/"><!--tocweblogo.gif--><img src="images/toclogo_30th.png" width="332" height="197" border="0"></a></div>
