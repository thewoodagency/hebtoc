...
<body>
<form class="jotform-form" action="register_proc2_broker.php" method="post" name="form_32814544278863" id="32814544278863" accept-charset="utf-8">
     ...
     <li class="form-line" id="id_5">
        ...
        <div id="cid_5" class="form-input">
          <select class="form-dropdown validate[required] selectfont" style="width:300px" id="level" name="level" onChange="javascript:checklevel();">
            <?php echo '<option value="'.$sp.'" selected="">'.$sp.'</option>'; //getTocLevel($sp); ?>
          </select>
        </div>
      </li>
