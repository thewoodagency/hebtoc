  ...
  <? } else { ?>
    <ul class="form-section">
      <li class="form-line" id="id_4">
        <div id="cid_4" class="form-input-wide">
          <table summary="" cellpadding="4" cellspacing="0" class="form-matrix-table">
            ...
            <tr><td colspan="7">
                    ...
                    Waiver form password: <b>HEBTOC2019</b></p>
        ...
        <div id="cid_3" class="form-input"><span class="form-sub-label-container">'.($i+1).'&nbsp;<input type="hidden" name="hid'.$i.'" value="'.$hid.'"><input class="form-textbox" type="text" size="20" name="first'.$i.'" id="first'.$i.'" ' . $firstname . ' />
            <label class="form-sub-label" for="first_3" id="sublabel_first"> First Name </label></span><span class="form-sub-label-container"><input class="form-textbox" type="text" size="20" name="last'.$i.'" id="last'.$i.'" ' . $lastname . ' />
          ...
          <select class="form-dropdown" style="width:50px" id="size'.$i.'" name="size'.$i.'">'.$size.'
			  ...
			  <td align="center" class="form-matrix-values">'.$waiverStatus.'</td>
			  <input type="hidden" class="form-textbox" id="waiver'.$i.'" name="waiver'.$i.'" size="30" value="' . $waiver . '"/>
			  <input type="hidden" class="form-textbox" id="signed'.$i.'" name="signed'.$i.'" size="30" value="' . $signed . '"/>
            </tr>';
