...
<body>
<form class="jotform-form" action="register_proc-a.php" method="post" name="form_32814544278863" id="32814544278863" accept-charset="utf-8">
    ...
    <!-- off season li><span style="font:bold;font-size:14px">Sponsorship Registration is closed. Please contact <a href="http://hebtoc.com/Contact">Kathy Ashwin</a> if you have any question.</span></li>-->
     <li class="form-line" id="id_5">
        ...
        <div id="cid_5" class="form-input">
          <select class="form-dropdown validate[required]" style="width:300px" id="level" name="level" onChange="javascript:checklevel();">
        ...
        <div id="cid_8" class="form-input">
          <table summary="" class="form-address-table" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td><span class="form-sub-label-container"><select class="form-dropdown validate[required] form-address-country" name="q8_address8_country" id="q8_address8_country">
