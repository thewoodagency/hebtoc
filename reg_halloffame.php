...
if(isset($_SESSION['email']))
{
	...
	//$qString = sprintf('select * from toc_hall where regEmail="%s" order by hid', $dbc->real_escape_string($regEmail));
    $qString = sprintf('select * from toc_hall where hfirst <> \'\' and regID="%s" and regEmail="%s" order by hid',
...
<form class="jotform-form" action="halloffame_proc.php" method="post" name="form_32946254898168" id="32946254898168" accept-charset="utf-8">
  <input type="hidden" name="formID" value="32946254898168" />
  <input type="hidden" name="noofPeople" value="<? echo $tocInfo['hall'] ?>">
  <div class="form-all">
  <? if ($tocInfo['hall'] == 0) { ?>
      ...
      <li class="form-line" id="id_4">
        <div id="cid_4" class="form-input-wide">
          <table summary="" cellpadding="4" cellspacing="0" class="form-matrix-table">
            <!-- header -->
            <tr><td colspan="7"><h3><? echo $tocInfo['hallh'] ?></h3><strong><? echo $tocInfo['hallm'] ?></strong><br><p style="background-color:#FF0;padding: 5px;"><strong>If anyone has dietary restrictions, please  email <a href="mailto:kashwin50@hotmail.com">Kathy Ashwin</a> prior to the event.</strong></p></td></tr>
            <tr>
      ...
      <li class="form-line" id="id_2">
        <div id="cid_2" class="form-input-wide">
          <div style="text-align:left" class="form-buttons-wrapper">
             <? include 'reg_submit_kathyOnly.php';//'reg_submit_no.php'; ?>
