...
if(isset($_SESSION['admin']) && $_SESSION['admin'] == 'kashwin50@hotmail.com')
{
	...
	$qString = 'SELECT toclevel, company, hfirst, hlast, night1, night2, night3, night4, night5, night6 FROM toc_hotel
inner join toc_register on regID=idtoc_register where hlast <> \'\' order by company, hlast';
	$r = $dbc->query($qString);
	$tbrows = '';
	$rowcolor = 0;
	while ($row = $r->fetch_assoc())
	{
		...
		$tbrows .= '<td>' . $row["toclevel"] . '</td><td>' .
					$row["company"] . '</td><td>' .
					$row["hlast"] . ', ' .$row["hfirst"] . '</td><td align="center">' .
...
<div id="content">
<p><a href="admin_hotel_excel.php">Excel</a></p>
<table id="myTable" class="tablesorter"> 
<thead><tr><th>Sponsorship level</th><th>Company Name</th><th>Name</th>
<th><? echo FIRST ?></th>
<th><? echo SECOND ?></th>
<th><? echo THIRD ?></th>
<th><? echo FOURTH ?></th>
