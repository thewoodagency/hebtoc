    ...
    <ul class="form-section">
     ...
     <li class="form-line jf-required" data-type="control_dropdown" id="id_1">
        ...
        <div id="cid_1" class="form-input jf-required">
          <select class="form-dropdown validate[required] selectfont" style="width:150px" id="department" name="department">
          ...
          <table summary="" cellpadding="4" cellspacing="0" class="form-matrix-table">
            ...
            <tr>
              ...
              Wednesday, June 5 - Welcome Dinner</h3>
                5:30 -  7:30 p.m. - Welcome Dinner Buffet - Exhibit Hall Level "B-C"<br>
