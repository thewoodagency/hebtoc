          ...
          <table summary="" cellpadding="4" cellspacing="0" class="form-matrix-table">
            ...
            <tr>
              <td colspan="7"><h3>Golf Tournament</h3> 
                ...
                Wednesday,  June 7 (AM Round  Only at TPC 7:30 Tee Off) : Golf Tournament at TPC for $125,000 - $175,000  Sponsors (if you have suppliers that are participating at this level and you  want to play golf with them, please sign up)                <br>
 <br>
                <input class="form-radio" type="checkbox" name="golf2" value="June 5" /> 
                </strong><strong>Friday,  June 9 : Golf  Tournament for $5,000 - $100,000 Sponsor Levels</strong>
        ...
        <div id="cid_4" class="form-input-wide">
          <table summary="" cellpadding="4" cellspacing="0" class="form-matrix-table">
            ...
            <tr>
              ...
              Wednesday, June 7 - Welcome Dinner</h3>
      ...
      <li class="form-line" id="id_4">
        <div id="cid_4" class="form-input-wide">
          <table summary="" cellpadding="4" cellspacing="0" class="form-matrix-table">
            ...
            Thursday, June 8 - Charity Work Project</h3>
