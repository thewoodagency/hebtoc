...
on toc_regid=idtoc_register where toc_firstname <> \'\' and toc_topgolf = 1 and toclevel in ("Humanitarian", "Chairman", "Presidential") order by company, toc_lastname';
	$r = $dbc->query($qString);
	$tbrows = '';
	$rowcolor = 0;
...
<div id="content">
<p><a href="admin_golf1_excel.php">Excel</a></p>
    <form class="jotform-form" action="admin_golf_proc.php" method="post" name="form_32946254898168" id="32946254898168" accept-charset="utf-8">
        ...
        <input type="hidden" name="golf" value="1" />
