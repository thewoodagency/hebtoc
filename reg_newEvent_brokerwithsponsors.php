...
<head>
    ...
    <style>
        ...
        .tooltip2 {
            position: relative;
            display: inline-block;
            border-bottom: 1px dotted #feacba; /* If you want dots under the hoverable text */
        }
        ...
        <div class="form-all">
			...
			'.$end.'
                            ...
                            <th class="form-matrix-column-headers form-matrix-column_5" style="background-color:<?php echo $s9 ?>; display: <?php echo $e9display ?>"  >
                                <?php if ($s9=='#feacba;') echo $alertImage ?><br/><p class="title">Sponsor Dinner<br>Hall of Frame (<?php echo FOURTH ?>)</p>
                            </th>
...
to complete the electronic form.</p><p>Waiver form link: <a target="_blank" href="http://hebtoc.com/waiver/Charity_Waiver">http://hebtoc.com/waiver/Charity_Waiver</a></p><p>Waiver form password: '.WAIVERCODE.'</p></div>';
                                        $tooltip = 2;
                                    }
        ...
        <input class="form-textbox" type="text"  name="title'.$i.'" id="title'.$i.'" ' . $title . ' />
            ...
            <label class="form-sub-label" for="last_3" id="sublabel_last"> Email</label></span>
              ...
              <!-- golf -->
                            ...
                            echo '<tr>
			<td align="center" class="form-matrix-values"><a href="./reg_newEvent_moreRow.php">+ Add more rows</a> <br><span style="color:red">If you make changes on this form, please click the "Update" button first before adding more rows.</span></td>
			<td align="center" class="form-matrix-values">&nbsp;</td>
			<td align="center" class="form-matrix-values">&nbsp;</td>
