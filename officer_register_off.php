            ...
            <tr>
              <td colspan="7"><h3>Golf Tournament</h3> 
                <p><strong>
                  ...
                  Wednesday, June 6 – TOPGOLF Tournament<br><br>This event is for $125,000 - $175,000 Sponsors (if you have suppliers that are participating at this level and you want to participate with them, please check this box)
                  <br><br>
                ...
                Friday, June 8: Golf Tournament for $5,000 - $100,000 Sponsor Levels </strong>
        ...
        <div id="cid_4" class="form-input-wide">
          <table summary="" cellpadding="4" cellspacing="0" class="form-matrix-table">
            ...
            <tr>
              ...
              Wednesday, June 6 - Welcome Dinner</h3>
      ...
      <li class="form-line" id="id_4">
        <div id="cid_4" class="form-input-wide">
          <table summary="" cellpadding="4" cellspacing="0" class="form-matrix-table">
            ...
            Thursday, June 7 - Charity Work Project</h3>
      ...
      <li class="form-line" id="id_4">
        <div id="cid_4" class="form-input-wide">
          <table width="506" cellpadding="4" cellspacing="0" class="form-matrix-table" summary="">
            ...
            Thursday, June 7 – Receptions and Sponsor Dinner</h3>
