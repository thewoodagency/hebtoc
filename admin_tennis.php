...
if(isset($_SESSION['admin']) && $_SESSION['admin'] == 'kashwin50@hotmail.com')
{
	...
	$qString = 'SELECT toclevel, company, hfirst, hlast, hrating, hemail, email FROM toc_tennis inner join toc_register on regID=idtoc_register where hlast <> \'\' order by company, hlast';
	$r = $dbc->query($qString);
	$tbrows = '';
	$rowcolor = 0;
...
<div id="content">
<p><a href="admin_tennis_excel.php">Excel</a></p>
<table id="myTable" class="tablesorter"> 
<thead><tr><th>Sponsorship level</th><th>Company Name</th><th>Player's Name</th><th>Rating</th><th>Email</th></tr></thead>
<? echo $tbrows; ?>
</table>
</div>
<!-- InstanceEndEditable -->
