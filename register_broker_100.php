...
session_start();
if(isset($_SESSION['admin'])) //when admin is logged in
{
...
<body>
<form class="jotform-form" action="register_proc2_broker_100.php" method="post" name="form_32814544278863" id="32814544278863" accept-charset="utf-8">
  ...
  <h3>If you have already registered, <a href="login_proc.php">please login to your account</a> to review or modify the sponsorship forms</h3><h3 align="right"><a href="/">Back to homepage</a></h3></div> 
    ...
    <!-- off season--> <!--<li><span style="font:bold;font-size:14px">Sponsorship Registration is closed. Please contact <a href="http://hebtoc.com/Contact">Kathy Ashwin</a> if you have any question.</span></li> -->
     <li class="form-line" id="id_5" style="display: none">
        <label class="form-label-left" id="label_5" for="input_5">
          Sponsorship Level<span class="form-required">*</span>
        </label>
        <div id="cid_5" class="form-input">
          <select class="form-dropdown selectfont" style="width:300px" id="level" name="level" onChange="javascript:checklevel();">
      ...
      <li class="form-line" id="id_1">
        <label class="form-label-left" id="label_1" for="input_1">
          Broker Company Name<span class="form-required">*</span>
        </label>
      ...
      <li class="form-line" id="id_13" style="display: none">
        <label class="form-label-left" id="label_13" for="input_13">
          H-E-B BDM with whom you work<span class="form-required">*</span>
        </label>
        <div id="cid_13" class="form-input">
          <input type="text" class="form-textbox" data-type="input-textbox" id="bdm" name="bdm" size="20" value=" " />
        </div>
      </li>
      <li class="form-line" id="id_2">
        <div id="cid_2" class="form-input-wide">
          ...
          <input class="form-radio" type="hidden" name="add" value="1"  />
