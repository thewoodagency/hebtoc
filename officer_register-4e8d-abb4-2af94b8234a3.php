            ...
            <tr>
              <td colspan="7"><h3>Golf Tournament</h3> 
                <p>
				  ...
				  Wednesday, June 5 – TOPGOLF Tournament</h3><br>This event is for $125,000 - $175,000 Sponsors (if you have suppliers that are participating at this level, please check this box and make plans to attend)
                  <br><br>
                ...
                <h3><input class="form-radio" type="checkbox" name="golf2" value="June 8" />
					Friday, June 7: Golf Tournament for $5,000 - $100,000 Sponsor Levels</h3>
...
<p><strong>(Golf Tournament locations determined by Department &amp;  Sponsorship Level)</strong></p>
  ...
  <p align="center"><u><strong><br>
    RELEASE, Authorization  To Reproduce Physical Likeness</strong></u></p>
                ...
                <p>Whereas,  HEB will be sponsoring and the TOC Trust will be hosting the HEB Tournament of  Champions (the &ldquo;TOC&rdquo;) and related activities, a charitable fundraiser  benefitting various and numerous charities throughout the state of Texas, on or  about June 5, 2019;  </p>
                <p>Whereas, the TOC  includes Charity Work Projects (the &ldquo;Charity Projects&rdquo;) held at several  locations in the Greater San Antonio area, including but not limited to those hosted  by the following participating organizations: Homes for Our Troops, the San  Antonio Food Bank, Daughters of Charity Services of San Antonio, Boys and Girls  Club of San Antonio, YMCA of Greater San Antonio and Tragedy Assistance Program  for Survivors (collectively, the &ldquo;Participating Organizations&rdquo;); </p>
  ...
  <option value="3XL">3XL</option>
            ...
            <select class="form-dropdown" id="ch_company" name="ch_company">
				...
				<option value="Boys &amp; Girls Club of S.A. - Calderon Branch">Boys &amp; Girls Club of S.A. - Calderon Branch</option>
				<option value="Daughters of Charity">Daughters of Charity</option>
				<option value="Davis Scott YMCA">Davis Scott YMCA</option>
         		<option value="Tragedy Assistance Program for Survivors (TAPS)">Tragedy Assistance Program for Survivors (TAPS)</option>
          </select></td></tr>
            </table>
            </div>
            </li>
