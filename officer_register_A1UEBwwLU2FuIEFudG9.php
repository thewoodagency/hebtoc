          ...
          <table summary="" cellpadding="4" cellspacing="0" class="form-matrix-table">
            ...
            <tr>
              <td colspan="7"><h3>Golf Tournament</h3> 
                <p><strong>
                  <input class="form-radio" type="checkbox" name="golf1" value="June 6" />
                  Wednesday, June 5 – TOPGOLF Tournament<br><br>This event is for $125,000 - $175,000 Sponsors (if you have suppliers that are participating at this level, please check this box and make plans to attend)
                  <br><br>
                  Note:  Partners will not be assigned to a specific Bay, they are required to spend time in each Bay where they have sponsoring companies participating.  Sponsor Bay assignments will be sent to you prior to this event.</strong><br>
                  <br>
                  <strong>7:00 a.m.  – Registration at JWM Exhibit Hall level (wear your TOC barcode name badge)</strong><br>
                ...
                <strong>11:00 –  12:00 noon - Buffet Lunch &amp; Winners Announced</strong>
                <strong><br>
                12:15 p.m. – Load  buses for return to JWM</strong><strong><br>
                <br>
                <input class="form-radio" type="checkbox" name="golf2" value="June 8" />
                Friday, June 7: Golf Tournament for $5,000 - $100,000 Sponsor Levels </strong>
...
<p><strong>(Golf Tournament locations determined by Department &amp;  Sponsorship Level)</strong></p>
  ...
  <option value="3XL">3XL</option>
            ...
            <select class="form-dropdown" id="ch_company" name="ch_company">
				...
				<option value="Ella Austin Community Center">Ella Austin Community Center</option>
				<option value="Sunshine Cottage School for the Deaf">Sunshine Cottage School for the Deaf</option>
				<option value="Kinetic Kids">Kinetic Kids</option>
         		<option value="Family Violence Prevention Services">Family Violence Prevention Services</option>
          </select></td></tr>
            </table>
            </div>
            </li>
