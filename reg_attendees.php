...
if(isset($_SESSION['email']))
{
	...
	$qString = sprintf('select * from toc_hotel where hfirst <> \'\' and regID="%s" and regEmail="%s" order by hid',
      ...
      <li class="form-line" id="id_4">
        <div id="cid_4" class="form-input-wide">
          <table summary="" cellpadding="4" cellspacing="0" class="form-matrix-table">
            <!-- header -->
            <tr><td colspan="7"><h3>Sponsor Summit / Hall of Fame / General Reception</h3></td></tr>
            <tr>
              ...
              <th class="form-matrix-column-headers form-matrix-column_1">Hall of Fame</th>
