...
if(isset($_SESSION['admin']) && $_SESSION['admin'] == 'kashwin50@hotmail.com')
{
	...
	$qString = 'SELECT toclevel, tlAmount, company, hfirst, hlast, htitle,hbdm, hflight FROM toc_golf inner join toc_register on regID=idtoc_register inner join toc_level on toclevel = tlName where hfirst <> \'\' order by company, hseq';
	$r = $dbc->query($qString);
	$tbrows = '';
	$rowcolor = 0;
...
<div id="content">
<p><a href="admin_golf_excel.php">Excel</a></p>
<table id="myTable" class="tablesorter"> 
<thead><tr><th>Sponsorship level</th><th>Company Name</th><th>Players</th><th>Title</th><th>H-E-B BDM</th><th>Flight</th></tr></thead>
<? echo $tbrows; ?>
</table>
</div>
<!-- InstanceEndEditable -->
