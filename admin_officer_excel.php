...
if(isset($_SESSION['admin']) && $_SESSION['admin'] == 'kashwin50@hotmail.com')
{
	...
	$today = date("m.d.Y");
	$filename = 'TOC-Officer-Registration-' . $today;
    $qString = "SELECT fname as 'First Name', lname as 'Last Name', title as 'Title', email as 'Email', CONCAT('(', oarea, ') ', ophone) as 'Office', 
...
FROM toc_partnerregister where tocflag='o'";
    ...
    echo TOCYEAR. " Officer Registration (printed on " . date("m/d/Y") . ")" . "\t";
