...
if(isset($_POST['formID']))
{
    ...
    $level="Humanitarian";//$_POST['level'];
    $damount = '0';
	...
	$qString = sprintf('replace into toc_register (idtoc_register, toclevel, damount, company, comtype, isbroker, broker100, fname, lname, addr1, addr2, city, state, zip, email, password, oarea, ophone, carea, cphone, bdm, registerd_date) 
values ("%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s")',
    ...
    if ($_SERVER['HTTP_REFERER'] == 'https://hebtoc.com/reg_info.php')
    {
        ...
        header("Location: reg_newEvent_broker_100.php"); /* Redirect browser */
    }
}