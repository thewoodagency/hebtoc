...
<form class="jotform-form" action="register_proc_partner.php" method="post" name="form_32814544278863" id="32814544278863" accept-charset="utf-8">
  ...
  <h3>If you have already registered, <a href="login_officer_proc.php">please login to your account</a> to review your information</h3><h3 align="right"><a href="/">Back to homepage</a></h3></div> 
          ...
          <table summary="" cellpadding="4" cellspacing="0" class="form-matrix-table">
            ...
            <tr>
              <td colspan="7"><h3>Golf Tournament</h3> 
                <p><strong>
                  <input class="form-radio" type="checkbox" name="golf1" value="June 3" />
                  Wednesday,  June 8 (AM Round  Only at TPC 7:30 Tee Off) : Golf Tournament at TPC for $125,000 - $175,000  Sponsors (if you have suppliers that are participating at this level and you  want to play golf with them, please sign up)<br>
                  <br>
                  <input class="form-radio" type="checkbox" name="golf2" value="June 5" />
                Friday,  June 10 : Golf  Tournament for $5,000 - $100,000 Sponsor Levels</strong></p>
      ...
      <li class="form-line" id="id_4">
        ...
        <div id="cid_3" class="form-input"><span class="form-sub-label-container"><input type="hidden" name="hid0" value="697"><input class="form-textbox" type="text" size="25" name="ch_first" id="ch_first" />
          ...
          <select class="form-dropdown" style="width:50px" id="ch_size" name="ch_size">
            ...
            <tr><td colspan="7" class="form-matrix-values" ><strong>Name of charity organization where you would like to participate:</strong>              
            <select class="form-dropdown" id="ch_company" name="ch_company">
		  		<option value="">Select</option>
				<option value="Home Build">Home Build</option>
				<option value="Food Bank">Food Bank</option>
				<option value="Boysville">Boysville</option>
      ...
      <li class="form-line" id="id_4">
        <div id="cid_4" class="form-input-wide">
          <table summary="" cellpadding="4" cellspacing="0" class="form-matrix-table">
            ...
            <p><strong>Hall of Fame Reception/Dinner - $125,000 - $175,000 Sponsor Levels</strong><br>
              4:30 - 6:30 p.m. - Cibolo Canyons Ballroom - Suite 3<br>
              6:30 - 7:00 p.m. - Move to Grand Oaks Ballroom &amp; everyone seated</p>
            <p><strong>Sponsor Reception/Dinner - $5,000 - $100,000 Sponsor Levels</strong><br>
