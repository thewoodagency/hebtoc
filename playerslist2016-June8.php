...
<h3>Tee Times (Wednesday, June 8) - 2016 H-E-B Tournament of Champions</h3>
...
<table width="734" cellpadding="5px" cellspacing="0">
  ...
  <tr>
    ...
    <td width="268"><strong>TPCC</strong> - JW Marriott / TPC    AT&amp;T Canyons</td>
    <td width="234">TPCO</strong> - JW Marriott / TPC AT&amp;T Oaks</td>
  </tr>
</table>
<br /><br />
<div id="demo">
...
<thead>
  <tr height="40">
    ...
    <td bgcolor="#6666cc" class="textheader"><div align="center"><strong>Teams</strong></div></td>
  ...
  for ($i=0; $i<$nRows; $i++){
	...
	if ($row['teams']!='' && $row['tlast']!='') { 
	  ...
	  echo '<td class="text">6:30 A.M.</td>';
