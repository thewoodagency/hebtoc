...
if(isset($_SESSION['email']))
{
    ...
    $qString = sprintf('SELECT * FROM toc_events inner join toc_register on toc_regEmail = email and toc_regid = idtoc_register where isbroker=1 and toc_regid = "%s" and toc_regEmail = "%s"',
...
function getErrorMessage($tocinfo) {
    ...
    if($_GET["golf"]==1) $error .= "<li>Golf &ndash;". $tocinfo['golf']. " participant(s) available (Each player can join either Topgolf or Golf. Can't play both)</li>";
    ...
    if ($error != "")
        $error = "<p style='font-size:14px'><img src=\"/images/exlamation.png\" width=\"35px\" style=\"vertical-align:middle\">&nbsp;
    ...
    <form class="jotform-form" action="reg_newEvent_broker_proc.php" method="post" name="form_32946254898168" id="32946254898168" accept-charset="utf-8">
        ...
        <div class="form-all">
			...
			'.$end.'
                            ...
                            <th class="form-matrix-column-headers form-matrix-column_0">
                                <p class="title">Officer/BDM Request for table</p>
                            </th>
                            <th class="form-matrix-column-headers form-matrix-column_0">
                                <p class="title">H-E-B Business Dev. Manager</p>
                            </th>
                            ...
                            <th class="form-matrix-column-headers form-matrix-column_4" style="width:50px" >
                                <p class="title">T-Shirt Size for CWP</p>
                            </th>
...
<p>PASSWORD for Wavier form: <span style="font-size:18px;font-weight: bold;color:#0000CC">'.WAIVERCODE.'</span></p></div>';
              ...
              <!-- golf -->';
                                ...
                                echo '
            <tr>
            <td align="center" class="form-matrix-values" width="125px">
             <span style="font-size:10px">'.str_pad(($i+1), 2, "0", STR_PAD_LEFT).'</span>
              ...
              <td align="center" class="form-matrix-values" width="100px">
			...
			<option value="National Brand Exclusive">National Brand Exclusive</option>
              ...
              <th align="left" class="form-matrix-row-headers" width="300px">
        ...
        <input class="form-textbox" type="text"  name="title'.$i.'" id="title'.$i.'" ' . $title . ' />
            ...
            <label class="form-sub-label" for="last_3" id="sublabel_last"> Email</label></span>
              ...
              <td align="center" class="form-matrix-values" width="100px">
                <span style="font-size:10px"><input type="text" class="form-textbox" id="table'.$i.'" name="table'.$i.'" size="25" ' . $table . '/>
              </td>
              <td align="center" class="form-matrix-values" width="100px">
              ...
              <td align="center" class="form-matrix-values">
                <select class="form-dropdown" style="width:45px" id="size'.$i.'" name="size'.$i.'">
		  		<option value="">Select</option>
				'.$size.'
              ...
              <!-- golf -->
                            ...
                            echo '<tr>
			<td colspan="2" align="center" class="form-matrix-values"><a href="./reg_newEvent_moreRow.php?sp=broker">+ Add more rows</a> <br><span style="color:red">If you make changes on this form, please click the "Update" button first before adding more rows.
