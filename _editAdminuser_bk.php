...
<div id="fnavi"><iframe frameborder="0" allowtransparency="true" scrolling="no" src="" width="1024" height="50"></iframe>
</div>
<div id="tocform">
<form class="jotform-form" action="_editupAdminuser.php" method="post" name="form_32814544278863999" id="32814544278863999" accept-charset="utf-8">
    <input type="hidden" name="formID" value="32814544278863999" />
    ...
    <ul class="form-section">
      <li class="form-line" id="id_9">
        ...
        <div id="cid_9" class="form-input">
          <input <?php echo $readonly ?> type="text" class="form-textbox validate[required]" data-type="input-textbox" id="username" name="username" size="20" value="<?php echo $email ?>" />
          </div>
        </li>
