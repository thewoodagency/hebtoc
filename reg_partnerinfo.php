...
12:15 p.m. – Load  buses for return to JWM</strong><br>
  ...
  <input type="radio" name="gender" value="female" <? //echo $female ?>> Female
      ...
      <li class="form-line" id="id_4">
        <div id="cid_4" class="form-input-wide">
          <table summary="" cellpadding="4" cellspacing="0" class="form-matrix-table">
            <!-- header -->
            <tr><td colspan="6"><h3><input style='<?php echo $showinputbox_CharityEvent ?>' <?php echo $disabledit ?> class="form-radio" type="checkbox" name="charity" value="charity" <?php echo $charity ?> />
            ...
            <tr style='display:block'>
              <td class="form-matrix-values">
                <strong>Shirt Size:</strong> <select <?php //echo $disabledit ?> class="form-dropdown" style="width:50px" id="ch_size" name="ch_size">
  <? echo $chsize ?>
  <option value="No Shirt">No Shirt</option>
  <option value="S">S</option>
  <option value="M">M</option>
  ...
  <option value="3XL">3XL</option>
            ...
            <tr style='<?php echo $showinputbox_CharityEvent ?>'><td colspan="7" class="form-matrix-values" >         
